...
public class UsbDeviceHandling {
  public static final String ACTION_USB_PERMISSION =
      UsbDeviceHandling.class.getName() + ".USB_PERMISSION";
  ...
  public UsbDeviceHandling(
      @NonNull Context context,
      int vid,
      int pid,
      @Nullable OnUsbDeviceHandlingResultListener listener) {
    this.mUSB_VID = vid;
    this.mUSB_PID = pid;
  ...
  public void start() {
    this.mUsbFsmHandler =
        new UsbFsmHandler(this.mContext, this.mUSB_VID, this.mUSB_PID, this.mListener);
  ...
  public static class UsbFsmHandler extends Handler {
    ...
    */
    private void searchUsbDevice() {
      ...
      Logger.d(
          "USB connect attempt "
              + this.mNumConnectingRetries
              + "/"
              + EVENT_FINALLY_NO_USBPERMISSION);
      if (this.mListener != null) {
        this.mListener.onUsbConnectAttemptStarted(
            this.mNumConnectingRetries, EVENT_FINALLY_NO_USBPERMISSION);
      }
      if (this.mUsbManager != null) {
        try {
          for (UsbDevice usbDevice : this.mUsbManager.getDeviceList().values()) {
            ...
            if (usbDevice.getProductId() == this.mUsbPid
                && usbDevice.getVendorId() == this.mUsbVid) {
    ...
    private void searchUsbDeviceX() {
      ...
      */
      throw new UnsupportedOperationException(
          "Method not decompiled: com.thf.dabplayer.utils.UsbDeviceHandling.UsbFsmHandler.searchUsbDevice():void");
    }
