...
public class PcmThread extends Thread {
    ...
    private class SharedPrefListener implements SharedPreferences.OnSharedPreferenceChangeListener {
        ...
        public void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String key) {
            if (key.equals(SettingsActivity.pref_key_declip)) {
                PcmThread.this.mIsClippedSampleDetectionEnabled = sharedPreferences.getBoolean(SettingsActivity.pref_key_declip, true);
            } else if (key.equals(SettingsActivity.pref_key_declip_notification)) {
                PcmThread.this.mIsClippedSampleNotificationEnabled = sharedPreferences.getBoolean(SettingsActivity.pref_key_declip_notification, true);
    ...
    private void m24a(int sampleRateInHz, int channels) {
        if (sampleRateInHz > 0) {
            ...
            SharedPreferences pref_settings = this.context.getSharedPreferences(SettingsActivity.prefname_settings, 0);
